  ...
  switch (guide) {
        ...
        content: () => (
          <GuideContainer
            ...
            text={`Access predefined ${
              envApplicationMode ? "applications" : "robots"
    ...
    case '[data-tut="fleet-sidebar-menu-item"]':
      return {
        ...
        content: () => (
          <GuideContainer
            title={envApplicationMode ? "Namespaces" : "Fleets"}
            text={
              envApplicationMode
    ...
    case '[data-tut="robot-sidebar-menu-item"]':
      return {
        ...
        content: () => (
          <GuideContainer
            title={envApplicationMode ? "Applications" : "Robots"}
            text={
              envApplicationMode
    ...
    case '[data-tut="robot-header"]':
      return {
        ...
        content: () => (
          <GuideContainer
            title={envApplicationMode ? "Application Header" : "Robot Header"}
            text={
              envApplicationMode
        ...
        content: () => (
          <GuideContainer
            ...
            text={`You can see the details of the ${
              envApplicationMode ? "application" : "robot"
            }.`}
          />
        ),
      };
    case '[data-tut="robot-service-buttons"]':
      return {
        ...
        content: () => (
          <GuideContainer
            title={
              envApplicationMode ? "Application Services" : "Robot Services"
            }
    ...
    case '[data-tut="robot-resources"]':
      return {
        ...
        content: () => (
          <GuideContainer
            title={
              envApplicationMode ? "Application Resources" : "Robot Resources"
            }
            text={
              envApplicationMode
    ...
    case '[data-tut="robot-status-widget"]':
      return {
        ...
        content: () => (
          <GuideContainer
            title={`${envApplicationMode ? "Application" : "Robot"} Status`}
    ...
    case "[data-tut='create-robot-step1-storage']":
      return {
        ...
        content: () => (
          <GuideContainer
            title={`${envApplicationMode ? "Application" : "Robot"} Storage`}
