...
export default function Header(): ReactElement {
  return (
    <div className="animate__animated animate__fadeInDown z-30 flex h-16 w-full items-center justify-between border-b border-light-200 bg-light-50 px-4 text-light-400 shadow-md">
      <Breadcrumb />
