...
export default function Sidebar(): ReactElement {
  ...
  return (
    <Fragment>
      <div className="animate__animated animate__fadeInLeft fixed z-40 flex h-screen w-16 select-none flex-col items-center gap-4 border-r border-layer-light-200 bg-layer-light-50 py-2 shadow-2xl lg:w-20 ">
        <Link to={`/`}>
          <img
            draggable="false"
