...
var eventemitter2 = {
  get exports() {
    return eventemitter2Exports;
  },
  set exports(v) {
    eventemitter2Exports = v;
  },
};
      ...
      if (this._all) {
        for (i = 0, l = this._all.length; i < l; i++) {
          ...
          switch (al) {
            ...
            case 3:
              promises.push(
                this._all[i].call(this, type, arguments$1[1], arguments$1[2])
              );
              break;
            default:
...
var ImageMapClient = /*@__PURE__*/ (function (EventEmitter2) {
  ...
  ImageMapClient.prototype = Object.create(
...
var OccupancyGridClient = /*@__PURE__*/ (function (EventEmitter2) {
  ...
  OccupancyGridClient.prototype = Object.create(
    EventEmitter2 && EventEmitter2.prototype
  );
...
var OccupancyGridSrvClient = /*@__PURE__*/ (function (EventEmitter2) {
  ...
  OccupancyGridSrvClient.prototype = Object.create(
    EventEmitter2 && EventEmitter2.prototype
  );
...
var PolygonMarker = /*@__PURE__*/ (function (superclass) {
  function PolygonMarker(options) {
    ...
    this.lineColor =
      options.lineColor || createjs__namespace.Graphics.getRGB(0, 0, 255, 0.66);
   ...
   * Internal use only
   */
  PolygonMarker.prototype.createLineShape = function createLineShape(
    startPoint,
    endPoint
  ) {
   ...
   * Internal use only
   */
  PolygonMarker.prototype.editLineShape = function editLineShape(
    line,
    startPoint,
    endPoint
  ) {
